...
const MyGallery = () => {
   ...
   const slides = [
      ...
      {src:"../../img/photos/DSCF5439.webp", description: "Iceland"},
      {src:"../../img/photos/DSCF5458.webp", description: "Iceland"},
      {src:"../../img/photos/DSCF5471.webp", description: "Iceland"},
      {src:"../../img/photos/DSCF5632.webp", description: "Iceland"},
      {src:"../../img/photos/DSCF5746.webp", description: "Iceland"},
      {src:"../../img/photos/DSCF5788.webp", description: "Iceland"},
      {src:"../../img/photos/DSCF6344.webp", description: "Iceland"},
      {src:"../../img/photos/DSCF6404.webp", description: "Iceland"},
      {src:"../../img/photos/DSCF6521.webp", description: "Iceland"},
      {src:"../../img/photos/IMG_20210422_144041_984.webp", description: "Iceland"},
      {src:"../../img/photos/IMG_20210422_144048_377.webp", description: "Iceland"},
      {src:"../../img/photos/IMG_20210422_144054_665.webp", description: "Iceland"},
      {src:"../../img/photos/DSCF8804.webp", description: "Iceland"},
      {src:"../../img/photos/DSCF8675.webp", description: "Iceland"},
      {src:"../../img/photos/DSCF8738.webp", description: "Iceland"},
      // {src:"../../img/photos/DSCF6467.webp", description: "Iceland"},
      {src:"../../img/photos/DSCF8863.webp", description: "Iceland"},
      {src:"../../img/photos/DSCF7722.webp", description: "Iceland"},
   ];
